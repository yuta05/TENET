...
from app.services.cs_agents.assistants.primary_assistant import assistant_runnable, primary_assistant_tools
...
from app.services.cs_agents.tools import fetch_user_flight_information
